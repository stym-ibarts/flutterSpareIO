...
class MenuLister extends StatefulWidget {
  const MenuLister({
    super.key,
  });

  @override
  _MenuListerState createState() => _MenuListerState();
}

class _MenuListerState extends State<MenuLister> {
  bool isMenuVisible = false; // Initially set to false
        ...
        child: Consumer<PanelProvider>(
          builder: (context, value, child) {
            ...
            return Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                // Add a button to toggle the menu visibility
                IconButton(
                  icon: Icon(isMenuVisible ? Icons.arrow_back : Icons.menu),
                  onPressed: toggleMenuVisibility,
                ),
                // Wrap the menu content in a Visibility widget to control its visibility
                Visibility(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      MenuWidget(
                        ...
                        isSelected:
                            provider.panelPage == PanelPage.notifications,
                        onPressed: () {
